...
export const swaggerDeleteAppointmentResponseExample = {
  description:
    'This endpoint is intended for urgent/error cases only. For regular cancellations, please use the designated cancellation endpoint to ensure proper tracking and processing of appointments.',
