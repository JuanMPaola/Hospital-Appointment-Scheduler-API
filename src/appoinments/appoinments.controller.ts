...
import {
  swaggerCancelAppointmentResponseExample,
  swaggerDeleteAppointmentResponseExample,
  swaggerGetUserAppointmentsResponseExample,
  swaggerPostAppointmentExample,
  swaggerPostAppointmentResponseExample,
  swaggerPostNearestAppointmentResponseExample,
  swaggerUpdateAppointmentExample,
  swaggerUpdateAppointmentResponseExample,
...
export class AppoinmentsController {
  ...
  update(
    @Param('id') id: string,
    @Body() updateAppointmentDto: UpdateAppoinmentDto,
  ) {
